                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            while (count < data.length()) {
                                ...
                                unU21.setNomJoueur(jsonObject.getString("nomPersonne"));
                               //Log.i("nom",unU21.getNomJoueur());
                                unU21.setPrenomJoueur(jsonObject.getString("prenomPersonne"));
...
//Récupération de L'identifiont de L'image
                            ...
                            Toast.makeText(Professionnel.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //Log.i("idCat", String.valueOf(3));
                       Toast.makeText(Professionnel.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                        error.getMessage();
                    }
                });
        ...
        listeU21.setAdapter(adapter);
                ...
                Button btnRetourProfessionnel = (Button) findViewById(R.id.btnRetourProfessionnel);
        //utilisation d'un Listener [interface de gestion d'événenents] pour récupérer L'interaction avec le bouton
        btnRetourProfessionnel.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Professionnel.this);
