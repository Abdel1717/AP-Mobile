                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            while (count < data.length()) {
                                ...
                                unSenior.setNomJoueur(jsonObject.getString("nomPersonne"));
                                //Log.i("nom",unSenior.getNomJoueur());
                                unSenior.setPrenomJoueur(jsonObject.getString("prenomPersonne"));
                                unSenior.setPoste(jsonObject.getString("poste"));
                                //unSenior.setNumero(jsonObject.getString("numero"));
